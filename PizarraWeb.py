...
while True:
    ...
    try:        
        ...
        #driver.get("https://bancalarapida.s3.us-east-1.amazonaws.com/index1.html")   #premios en github    
        #driver.get("https://bancalarapida.pages.dev/index.html")   #premios en S3
        #driver.get("https://bancalarapida.pages.dev/index1.html")   #premios en github
        #driver.get("https://bancalarapida.github.io/index.html")   #premios en S3
        #driver.get("https://bancalarapida.github.io/index1.html")   #premios en github
    except:
        print(sys.exc_info())
    time.sleep(3600)
